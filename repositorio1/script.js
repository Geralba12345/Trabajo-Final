...
if (promedioPuntos < 30){
  alert(`Su jugador tiene ${promedioPuntos} puntos por partido. Con este promedio su jugador no será considerado para el MVP`)
}else{
  alert(`Su jugador tiene ${promedioPuntos} puntos por partido. Su jugador puede ser considerado para el MVP`)
}
}
